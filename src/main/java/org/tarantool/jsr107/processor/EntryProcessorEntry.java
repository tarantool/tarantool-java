...
import org.tarantool.jsr107.CachedValue;
...
public class EntryProcessorEntry<K, V> implements MutableEntry<K, V> {
  ...
  /**
   * The {@link org.tarantool.jsr107.CachedValue} for the {@link MutableEntry}.
   */
   ...
   * @param cachedValue the {@link CachedValue} of the {@link MutableEntry}
  ...
  public EntryProcessorEntry(K key,
                             CachedValue cachedValue, long now,
