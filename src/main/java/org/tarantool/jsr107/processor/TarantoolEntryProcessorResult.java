 ...
 */
public class TarantoolEntryProcessorResult<T> implements EntryProcessorResult<T> {
  /**
  ...
  /**
   * Constructs an {@link TarantoolEntryProcessorResult} for a resulting value
   *
   * @param result  the result
   */
  public TarantoolEntryProcessorResult(T result) {
    this.result = result;
    this.exception = null;
  }

  /**
   * Constructs an {@link TarantoolEntryProcessorResult} for an {@link Exception},
   * that of which will be returned wrapped as an {@link EntryProcessorException}.
   *
   * @param exception  the {@link Exception}
   */
  public TarantoolEntryProcessorResult(Exception exception) {
    this.result = null;
