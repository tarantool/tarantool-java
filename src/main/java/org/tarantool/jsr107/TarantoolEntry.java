 ...
 */
public class TarantoolEntry<K, V> implements Cache.Entry<K, V> {
  private final K key;
   ...
   * Constructor
   */
  public TarantoolEntry(K key, V value) {
    this.key = key;
    this.value = value;
    this.oldValue = null;
  }
   ...
   * Constructor
   */
  public TarantoolEntry(K key, V value, V oldValue) {
    this.key = key;
    this.value = value;
  ...
  public boolean equals(Object o) {
    ...
    TarantoolEntry<?, ?> e2 = (TarantoolEntry<?, ?>) o;
